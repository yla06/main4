...
if ( isset( $_POST['submit_goods_add'] ) )
{
  if ( $group -> isValid( Field::METHOD_POST )  )
  {
    ...
    if ( mysql_query( $sql ) )
    {
      ...
      {
        $save_path = MC_ROOT . '/upload/goods/' . mysql_insert_id();
        ...
        setError( 'Товар НЕ создан. Попробуйте еще раз' );
    }
    else
...
<section class="collection-heading heading-content ">
  <div class="container">
    <div class="row">
        ...
        <h1 class="collection-title"><span>Добавить новый товар</span></h1>
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-12">
          <input class="btn" name="submit_goods_add" type="submit" value="Добавить">
          </div>
        </form>
						</div>
    </div>
